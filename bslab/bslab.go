...
func (i Info) String() string {
	...
	for _, size := range sizes {
		...
		out = append(out, ' ')
		out = append(out, ustr.String(hcount(i.Values[size][0]), 10)...)
		out = append(out, ' ')
		out = append(out, ustr.String(hcount(i.Values[size][1]), 10)...)
		out = append(out, ' ')
		out = append(out, ustr.String(hcount(i.Values[size][2]), 8)...)
		out = append(out, ' ')
		out = append(out, ustr.String(hsize(i.Values[size][3]), 10)...)
		out = append(out, ' ')
		out = append(out, ustr.String(hcount(i.Values[size][4]), 8)...)
		out = append(out, '\n')
	}
	out = append(out, "------------------------------------------------------------\n"...)
